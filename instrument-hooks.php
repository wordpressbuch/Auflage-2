...
Description: Instruments Hooks for a Page. Outputs during the Shutdown Hook. - ?instruments=hooks
Version: 0.1
...
if ( isset($_GET['instruments']) && $_GET['instruments']=='hooks') {
...
<div align="center" id="instrumented-hook-list">
	...
	function record_hook_usage($hook){
		...
		if (!$in_hook) {
			...
			$file_name = addslashes( 
				str_replace($doc_root, '', $callstack[3]['file'])
			);
